...
export default function FixturesListPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0f13]">
      {/* Sticky Header */}
      <div className="sticky top-0 z-40 bg-[#0f0f13]/95 backdrop-blur-md border-b border-gray-800/50">
        <div className="px-4 py-4">
          <h1 className="text-xl font-bold text-white mb-4">AFCON 25 Fixtures</h1>
      ...
      <div className="px-4 py-6">
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">No Fixtures Found</h3>
